"""
Stage 2 v3: REPLACE mode, LLM switched to typhoon2.5-qwen3-4b.

Changes from v2 (single-variable discipline — everything else identical):
...
OUTPUT_DIR = '/data/workspace/asr-model-training/thai-understanding/u_align_stage2_v3'
RESUME_FILE = '/data/workspace/asr-model-training/thai-understanding/u_align_stage2_v3_resume.json'
...
# ============ Training & Eval ============
def train(args):
    print("=== Stage 2 v3: REPLACE mode + typhoon2.5-qwen3-4b ===\n")
    ...
    def run_eval_and_log(step, data, subset_name):
        ...
        print(f"  >> step {step} {subset_name} SER = {ser:.4f} (avg sim = {1-ser:.4f})", flush=True)
    ...
    for epoch in range(args.epochs):
        for batch_idx, batch in enumerate(train_loader):
            ...
            if (batch_idx + 1) % args.grad_accum == 0:
                ...
                if smoke_stop or global_step % args.eval_every == 0:
