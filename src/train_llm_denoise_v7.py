"""Stage 2 v7 (discriminating experiment): CTC-draft text cascade.
...
OUTPUT_DIR = '/data/workspace/asr-model-training/thai-understanding/u_align_stage2_v7'
EVAL_HISTORY = f'{OUTPUT_DIR}/eval_history.jsonl'
RESUME_FILE = '/data/workspace/asr-model-training/thai-understanding/u_align_stage2_v7_resume.json'
