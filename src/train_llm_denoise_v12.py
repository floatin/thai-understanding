"""Stage 2 v12: multi-hypothesis cascade (A|B|C|S drafts) - consensus reconstruction.

(v11 was: v7 recipe on v10 beam drafts + expanded pool.
...
DRAFTS = '/data/workspace/asr-model-training/thai-understanding/ctc_drafts_v12.json'
...
OUTPUT_DIR = '/data/workspace/asr-model-training/thai-understanding/u_align_stage2_v12'
EVAL_HISTORY = f'{OUTPUT_DIR}/eval_history.jsonl'
RESUME_FILE = '/data/workspace/asr-model-training/thai-understanding/u_align_stage2_v12_resume.json'
